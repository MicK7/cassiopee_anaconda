...
PyObject* K_POST::sharpEdges(PyObject* self, PyObject* args)
{
  ...
  E_Float ptA1[nfld]; E_Float ptB1[nfld]; E_Float ptC1[nfld]; E_Float ptD1[nfld];
  E_Float ptA2[nfld]; E_Float ptB2[nfld]; E_Float ptC2[nfld]; E_Float ptD2[nfld];
  ...
  if (type == 2) // BAR
  {
    ...
    for (E_Int et1 = 0; et1 < nelts; et1++)
    {
      ...
      for (E_Int noet2 = 0; noet2 < nvoisins; noet2++)
      {
        ...
        E_Float alpha = K_COMPGEOM::getAlphaAngleBetweenBars(ptA1, ptB1, ptA2, ptB2, dirVect);
  ...
  else if ( type == 3 ) // TRI 
  {
    ...
    for (E_Int et1 = 0; et1 < nelts; et1++)
    {
      ...
      for (E_Int noet2 = 0; noet2 < nvoisins; noet2++)
      {
        ...
        E_Float alpha = K_COMPGEOM::getAlphaAngleBetweenTriangles(ptA1, ptB1, ptC1, ptA2, ptB2, ptC2);
  ...
  else if (type == 4) //QUAD
  {
    ...
    for (E_Int et1 = 0; et1 < nelts; et1++)
    {
      ...
      for (E_Int noet2 = 0; noet2 < nvoisins; noet2++)
      {
        ...
        E_Float alpha = 
          K_COMPGEOM::getAlphaAngleBetweenQuads(ptA1, ptB1, ptC1, ptD1, 
                                                ptA2, ptB2, ptC2, ptD2);
        if ( (alpha < alphamin || alpha > alphamax ) && alpha != -1000.) 
        {
          found1 = 0; found2 = 0;
