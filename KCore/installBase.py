...
False, # static
False, # CPlotOffScreen
['/home/benoit/include'], # additionalIncludePaths
[], # additionalLibs
['/home/benoit/lib'] # additionalLibPaths
],
###############################################################################
'ldads': [ 'Onera-ldads',
'ifort', # f77compiler
...
['c:/TDM-GCC-64/lib', 'c:/Python27/libs'] # additionalLibPaths
],
###############################################################################
'fulvio': [ 'Onera gfx',
'ifort', # f77compiler
...
###############################################################################
'Raspail': [ 'Onera DTIM',
'ifort.exe', # f77compiler
'ifort.exe', # f90compiler
'icl.exe', # Cppcompiler
[], # CppAdditionalOptions
[], # f77AdditionalOptions
False, # useOMP
