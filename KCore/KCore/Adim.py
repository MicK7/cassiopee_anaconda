...
# IN: TurbRateInf: taux de turbulence a l'infini en pourcentage de Uinf
# (pour k-w uniquement)
#==============================================================================
def adim1(MInf=0.5, alphaZ=0., alphaY=0., ReInf=1.e8, MutSMuInf=0.2,
    ...
    # Pour k-omega
    RokInf = RoInf * TurbRateInf * UInf
    
    MutInf = MutSMuInf * MuInf
    RoomegaInf = RokInf / max(MutInf, 1.e-10)
