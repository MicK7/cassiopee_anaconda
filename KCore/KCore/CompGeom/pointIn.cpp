...
*/
//=============================================================================
E_Int K_COMPGEOM::pointInPolygon2D(K_FLD::FldArrayF& coord,
                                   ...
                                   E_Float* Ball, E_Float* BB)
{
  ...
  for (E_Int i = 0; i < na; i++)
  {
    ...
    p0[0] = coord(ind1,1); p0[1] = coord(ind1,2); p0[2] = coord(ind1,3);
    p1[0] = coord(ind2,1); p1[1] = coord(ind2,2); p1[2] = coord(ind2,3);
                                   ...
                                   E_Float* Ball, E_Float* BB)
{
  ...
  ret = pointInPolygon2D(coord, connect,
                         pt,
                         Ball, BB);
  if (ret == 1) return 1;
  pt[0] = p[0] + epsilon;
