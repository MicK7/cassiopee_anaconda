...
# Acces a Distributed
from Distributed import readZones, convert2PartialTree, convert2SkeletonTree
...
#==============================================================================
# IN: t: zone node, tree, ...
# IN: nproc: number of proc to set
#==============================================================================
def setProc(t, nproc):
    tp = Internal.copyRef(t)
    Distributed._setProc(tp, nproc)
    return tp

def _setProc(t, nproc):
    Distributed._setProc(z, nproc)
    return None
