...
t = Distributed.readZones(t, LOCAL+'/test.hdf', proc=0)
t = Distributed.readZones(t, LOCAL+'/test.hdf', proc=1)
test.testT(t, 1)
...
(t, dic) = Distributor2.distribute(t, NProc=2, algorithm='fast')
t = Distributed.readZones(t, LOCAL+'/test.adf', proc=0)
t = Distributed.readZones(t, LOCAL+'/test.adf', proc=1)
test.testT(t, 2)
