...
namespace K_GEOM
{
  ...
  void compCCCenters(K_FLD::FldArrayF& coord, K_FLD::FldArrayI& cn, 
                     K_FLD::FldArrayF& coordCC);
  /* Parmi tous les points de coord, trouve celui qui est le plus proche 
     de P */
  E_Int findNearestVertex(K_FLD::FldArrayF& coord, E_Float* P);
  ...
  */
  void compTetraType1(E_Int type0,
                      K_FLD::FldArrayF& coordpoly1, K_FLD::FldArrayI& cnpoly1,
  ...
  */
  void compTetraType12(K_FLD::FldArrayF& coordpoly1, 
                       K_FLD::FldArrayI& cnpoly1,
                       K_FLD::FldArrayI& cn1,
                       K_FLD::FldArrayF& coordCC1, K_FLD::FldArrayF& coord1,
                       K_FLD::FldArrayF& coordpoly2, 
                       K_FLD::FldArrayI& cnpoly2,
  ...
  */
  E_Int testIfEdgesCentersInContour(
    ...
    K_FLD::FldArrayF& coord, K_FLD::FldArrayF& coordc, 
    K_FLD::FldArrayI& cnc);
