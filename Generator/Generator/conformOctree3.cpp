      ...
      if (K_FUNC::E_abs(levels[et]) == l0 ) 
      {
        ...
        if (nvert == 4) // cas 2D
        {
          switch (ntag)
          {
            ...
            case 1:
              insert2DPattern1(et, levels[et], tag, f, cn, fo, cno, levelso, eto, no);
              restart = 1;
              break;
              
            case 2:
              insert2DPattern2(et, levels[et], tag, f, cn, fo, cno, levelso, eto, no);
              restart = 1;
              break;
              
            case 3:
              insert2DPattern3(et, levels[et], tag, f, cn, fo, cno, levelso, eto, no);
              restart = 1;
              break;
              
            case 4:
              insert2DPattern4(et, levels[et], tag, f, cn, fo, cno, levelso, eto, no);
              restart = 1;
              break;
        ...
        else // 3D
        {
          switch (ntag)
          {
            ...
            case 1:
              insert3DPattern1(et, levels[et], tag, f, cn, fo, cno, levelso, eto, no);
              restart = 1;
              break;
            ...
            */
            ...
            case 7:
            case 8:
              insert3DPattern4(et, levels[et], tag, f, cn, fo, cno, levelso, eto, no);
              restart = 1;
              break;
                                   ...
                                   E_Int& eto, E_Int& no)
{
  ...
  if (tag[0] == 1 && tag[1] == 1 && tag[2] == 1 && tag[3] == 1)
  {
    ...
    for (E_Int nf = 1; nf <= nfld; nf++) fo(no, nf) = f(c5, nf); no++;
    for (E_Int nf = 1; nf <= nfld; nf++) fo(no, nf) = f(c6, nf); no++;
    for (E_Int nf = 1; nf <= nfld; nf++) fo(no, nf) = f(c7, nf); no++;
    for (E_Int nf = 1; nf <= nfld; nf++) fo(no, nf) = f(c8, nf); no++;
