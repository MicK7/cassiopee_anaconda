...
PyObject* K_GENERATOR::_bboxIntersectionZ(PyObject* self, PyObject* args)
{
  ...
  if (!PyArg_ParseTuple(args, "OOd", &zone1, &zone2, &tol)) return NULL;
  ...
  vector<E_Int*> cn1;
  K_PYTREE::getFromZone(
    zone1, 1, 0, varString1, fields1, locs1, im1, jm1, km1, 
  ...
  vector<E_Int*> cn2;
  K_PYTREE::getFromZone(
    zone2, 1, 0, varString2, fields2, locs2, im2, jm2, km2, 
